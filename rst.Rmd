...
mercado=mercado[c("Acción","Número de acciones","Precio Bs.", "Precio $USD","Capitalización Bs","Capitalización $USD")]
 ...
 resumen=data.frame(
    ...
    valor=c( RST$precio, min(RST$accion_usd$RST.Close), max(RST$accion_usd$RST.Close), mean(RST$accion_usd$RST.Close),
        as.numeric(var(RST$accion_usd$RST.Close)), mean(RST$accion_usd$RST.Volume), mercado[mercado$`Acción`=="RST",6], mercado[mercado$`Acción`=="RST",2])
