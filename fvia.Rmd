...
mercado=mercado[c("Acción","Número de acciones","Precio Bs.", "Precio $USD","Capitalización Bs","Capitalización $USD")]
 ...
 resumen=data.frame(
    ...
    valor=c( FVI.A$precio, min(FVI.A$accion_usd$FVI.A.Close), max(FVI.A$accion_usd$FVI.A.Close), mean(FVI.A$accion_usd$FVI.A.Close),
        as.numeric(var(FVI.A$accion_usd$FVI.A.Close)), mean(FVI.A$accion_usd$FVI.A.Volume), mercado[mercado$`Acción`=="FVI.A",6], mercado[mercado$`Acción`=="FVI.A",2])
