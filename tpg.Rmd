...
mercado=mercado[c("Acción","Número de acciones","Precio Bs.", "Precio $USD","Capitalización Bs","Capitalización $USD")]
 ...
 resumen=data.frame(
    ...
    valor=c( TPG$precio, min(TPG$accion_usd$TPG.Close), max(TPG$accion_usd$TPG.Close), mean(TPG$accion_usd$TPG.Close),
        as.numeric(var(TPG$accion_usd$TPG.Close)), mean(TPG$accion_usd$TPG.Volume), mercado[mercado$`Acción`=="TPG",6], mercado[mercado$`Acción`=="TPG",2])
