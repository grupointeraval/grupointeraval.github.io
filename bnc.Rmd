...
mercado=mercado[c("Acción","Número de acciones","Precio Bs.", "Precio $USD","Capitalización Bs","Capitalización $USD")]
 ...
 resumen=data.frame(
    ...
    valor=c( bnc$precio, min(bnc$accion_usd$BNC.Close), max(bnc$accion_usd$BNC.Close), mean(bnc$accion_usd$BNC.Close),
        as.numeric(var(bnc$accion_usd$BNC.Close)), mean(bnc$accion_usd$BNC.Volume), mercado[mercado$`Acción`=="BNC",6], mercado[mercado$`Acción`=="BNC",2])
