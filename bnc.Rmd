---
title: "Banco Nacional de Crédito (Reporte Grupo Interaval)"
...
<p align="center">
  <img width="320px" height="100px" src="bnc.png">
</p>

Es una institución financiera venezolana de capital privado especializado en banca universal. Abre sus puertas en San Antonio del Táchira, Estado Táchira en julio de 1977 como Banco Tequendama sucursal del banco del mismo nombre en Colombia. Es una empresa que cotiza  en la Bolsa de Valores de Caracas bajo el símbolo "BNC" y hasta la fecha mantiene 5.791.930.372 acciones en circulación.
...
library(kableExtra)
  ...
  mercado=data.frame(
    ...
    numero_de_acciones=c( 5791930372),
...
mercado=mercado[c("Acción","Número de acciones","Precio Bs.", "Precio $USD","Capitalización Bs","Capitalización $USD")]
 ...
 resumen=data.frame(
    ...
    valor=c( bnc$precio, mercado[mercado$`Acción`=="BNC",4], min(bnc$accion_usd$BNC.Close), max(bnc$accion_usd$BNC.Close), mean(bnc$accion_usd$BNC.Close),
        as.numeric(var(bnc$accion_usd$BNC.Close)), mercado[mercado$`Acción`=="BNC",6], mercado[mercado$`Acción`=="BNC",2])
...
accion=datos_accion(accion,paste("C:/Users/analista04/Documents/R/grupointeraval.github.io/","bnc.txt",sep=""),"BNC")
accion$grafico_usd
```
...
```{r echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE}
library(DT)
excel=as.data.frame(bnc$accion_usd)
excel[,4] <- NULL
...
```{r echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE}
library(DT)
excel2=as.data.frame(bnc$accion_bs)
