...
mercado=mercado[c("Acción","Número de acciones","Precio Bs.", "Precio $USD","Capitalización Bs","Capitalización $USD")]
 ...
 resumen=data.frame(
    ...
    valor=c( CRM.A$precio, min(CRM.A$accion_usd$CRM.A.Close), max(CRM.A$accion_usd$CRM.A.Close), mean(CRM.A$accion_usd$CRM.A.Close),
        as.numeric(var(CRM.A$accion_usd$CRM.A.Close)), mean(CRM.A$accion_usd$CRM.A.Volume), mercado[mercado$`Acción`=="CRM.A",6], mercado[mercado$`Acción`=="CRM.A",2])
