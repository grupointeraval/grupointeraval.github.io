...
mercado=mercado[c("Acción","Número de acciones","Precio Bs.", "Precio $USD","Capitalización Bs","Capitalización $USD")]
 ...
 resumen=data.frame(
    ...
    valor=c( BVL$precio, min(BVL$accion_usd$BVL.Close), max(BVL$accion_usd$BVL.Close), mean(BVL$accion_usd$BVL.Close),
        as.numeric(var(BVL$accion_usd$BVL.Close)), mean(BVL$accion_usd$BVL.Volume), mercado[mercado$`Acción`=="BVL",6], mercado[mercado$`Acción`=="BVL",2])
