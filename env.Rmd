...
mercado=mercado[c("Acción","Número de acciones","Precio Bs.", "Precio $USD","Capitalización Bs","Capitalización $USD")]
 ...
 resumen=data.frame(
    ...
    valor=c( ENV$precio, min(ENV$accion_usd$ENV.Close), max(ENV$accion_usd$ENV.Close), mean(ENV$accion_usd$ENV.Close),
        as.numeric(var(ENV$accion_usd$ENV.Close)), mean(ENV$accion_usd$ENV.Volume), mercado[mercado$`Acción`=="ENV",6], mercado[mercado$`Acción`=="ENV",2])
