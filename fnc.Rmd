---
title: "Fábrica Nacional de Cementos"
...
mercado=mercado[c("Acción","Número de acciones","Precio Bs.", "Precio $USD","Capitalización Bs","Capitalización $USD")]
 ...
 resumen=data.frame(
    ...
    valor=c( FNC$precio, min(FNC$accion_usd$FNC.Close), max(FNC$accion_usd$FNC.Close), mean(FNC$accion_usd$FNC.Close),
        as.numeric(var(FNC$accion_usd$FNC.Close)), mean(FNC$accion_usd$FNC.Volume), mercado[mercado$`Acción`=="FNC",6], mercado[mercado$`Acción`=="FNC",2])
