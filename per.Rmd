---
title: " PC-IBC Fondo Mutual de Inv. Cap. Cerrado  (Reporte Grupo Interaval)"
...
<p align="center">
  <img width="320px" height="72px" src="per.png">
</p>


Su objetivo es invertir el capital social en los títulos valores que conforman el IBC, buscando replicar los resultados del Índice Bursátil Caracas el índice subyacente, que mide el rendimiento del sector de gran capitalización del mercado de renta variable de Venezuela.
...
accion=datos_accion(accion,paste("C:/Users/analista04/Documents/R/grupointeraval.github.io/","per.txt",sep=""),"PER")
accion$grafico_usd
```
...
```{r echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE}
library(DT)
excel=as.data.frame(per$accion_usd)
excel[,4] <- NULL
...
```{r echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE}
library(DT)
excel2=as.data.frame(per$accion_bs)
