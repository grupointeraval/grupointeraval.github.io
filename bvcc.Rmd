...
mercado=mercado[c("Acción","Número de acciones","Precio Bs.", "Precio $USD","Capitalización Bs","Capitalización $USD")]
 ...
 resumen=data.frame(
    ...
    valor=c( BVCC$precio, min(BVCC$accion_usd$BVCC.Close), max(BVCC$accion_usd$BVCC.Close), mean(BVCC$accion_usd$BVCC.Close),
        as.numeric(var(BVCC$accion_usd$BVCC.Close)), mean(BVCC$accion_usd$BVCC.Volume), mercado[mercado$`Acción`=="BVCC",6], mercado[mercado$`Acción`=="BVCC",2])
