---
title: "Ron Santa Teresa (Reporte Grupo Interaval)"
...
<p align="center">
  <img width="250px" height="90px" src="rst.png">
</p>

Ron Santa Teresa es una de las marcas más emblemáticas del ron venezolano siendo una empresa productora de ron con más de 200 años tradición. Es administrada por la familia Vollmer desde su icónica hacienda ubicada en el Consejo, Estado Aragua. Se encuentra registrada en la Bolsa de Valores de Caracas bajo el símbolo "RST" y mantiene unas 285.642.388 accionas en circulación.
...
library(kableExtra)
  ...
  datos_accion <-function(accion, directorio, nombre){
    ...
    colnames(accion)<-c("Fecha","Tipo.de.operacion",paste(nombre,".Open",sep=""),paste(nombre,".Close",sep=""),
                        ...
                        ".Cantidad.de.Operaciones",paste(nombre,".Volume",sep=""),".Monto.RST.Bctivo")
    ...
    accion=accion[c("Fecha", paste(nombre,".Open",sep=""), paste(nombre,".High",sep=""), 
                    ...
                    ".Cantidad.de.Operaciones", ".Monto.RST.Bctivo", "Tipo.de.operacion") ]
    ##REVISADO
  ...
  RST.B=datos_accion(accion,paste("C:/Users/analista04/Documents/R/grupointeraval.github.io//","RST.B.txt",sep=""),"RST.B")
  ...
  mercado=data.frame(
    ...
    numero_de_acciones=c(1747687),
    
    
    precio=c(RST.B$precio)
...
mercado=mercado[c("Acción","Número de acciones","Precio Bs.", "Precio $USD","Capitalización Bs","Capitalización $USD")]
 ...
 resumen=data.frame(
    ...
    valor=c( RST.B$precio, mercado[mercado$`Acción`=="RST.B",4], min(RST.B$accion_usd$RST.B.Close), max(RST.B$accion_usd$RST.B.Close), mean(RST.B$accion_usd$RST.B.Close),
        as.numeric(var(RST.B$accion_usd$RST.B.Close)),  mercado[mercado$`Acción`=="RST.B",6], mercado[mercado$`Acción`=="RST.B",2])
...
accion=datos_accion(accion,paste("C:/Users/analista04/Documents/R/grupointeraval.github.io/","rst.b.txt",sep=""),"RST.B")
accion$grafico_usd
```
...
```{r echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE}
library(DT)
excel=as.data.frame(RST.B$accion_usd)
excel[,4] <- NULL
...
```{r echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE}
library(DT)
excel2=as.data.frame(RST.B$accion_bs)
