...
mercado=mercado[c("Acción","Número de acciones","Precio Bs.", "Precio $USD","Capitalización Bs","Capitalización $USD")]
 ...
 resumen=data.frame(
    ...
    valor=c( RST.B$precio, min(RST.B$accion_usd$RST.B.Close), max(RST.B$accion_usd$RST.B.Close), mean(RST.B$accion_usd$RST.B.Close),
        as.numeric(var(RST.B$accion_usd$RST.B.Close)), mean(RST.B$accion_usd$RST.B.Volume), mercado[mercado$`Acción`=="RST.B",6], mercado[mercado$`Acción`=="RST.B",2])
