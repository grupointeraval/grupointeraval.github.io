...
mercado=mercado[c("Acción","Número de acciones","Precio Bs.", "Precio $USD","Capitalización Bs","Capitalización $USD")]
 ...
 resumen=data.frame(
    ...
    valor=c( DOM$precio, min(DOM$accion_usd$DOM.Close), max(DOM$accion_usd$DOM.Close), mean(DOM$accion_usd$DOM.Close),
        as.numeric(var(DOM$accion_usd$DOM.Close)), mean(DOM$accion_usd$DOM.Volume), mercado[mercado$`Acción`=="DOM",6], mercado[mercado$`Acción`=="DOM",2])
