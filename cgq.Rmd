---
title: "Corporación Grupo Químico"
...
mercado=mercado[c("Acción","Número de acciones","Precio Bs.", "Precio $USD","Capitalización Bs","Capitalización $USD")]
 ...
 resumen=data.frame(
    ...
    valor=c( CGQ$precio, min(CGQ$accion_usd$CGQ.Close), max(CGQ$accion_usd$CGQ.Close), mean(CGQ$accion_usd$CGQ.Close),
        as.numeric(var(CGQ$accion_usd$CGQ.Close)), mean(CGQ$accion_usd$CGQ.Volume), mercado[mercado$`Acción`=="CGQ",6], mercado[mercado$`Acción`=="CGQ",2])
