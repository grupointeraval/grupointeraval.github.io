---
title: "Corporación Industrial de Energía"
...
mercado=mercado[c("Acción","Número de acciones","Precio Bs.", "Precio $USD","Capitalización Bs","Capitalización $USD")]
 ...
 resumen=data.frame(
    ...
    valor=c( CIE$precio, min(CIE$accion_usd$CIE.Close), max(CIE$accion_usd$CIE.Close), mean(CIE$accion_usd$CIE.Close),
        as.numeric(var(CIE$accion_usd$CIE.Close)), mean(CIE$accion_usd$CIE.Volume), mercado[mercado$`Acción`=="CIE",6], mercado[mercado$`Acción`=="CIE",2])
