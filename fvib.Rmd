---
title: "Fondo de Valores Inmobiliarios"
...
mercado=mercado[c("Acción","Número de acciones","Precio Bs.", "Precio $USD","Capitalización Bs","Capitalización $USD")]
 ...
 resumen=data.frame(
    ...
    valor=c( FVI.B$precio, min(FVI.B$accion_usd$FVI.B.Close), max(FVI.B$accion_usd$FVI.B.Close), mean(FVI.B$accion_usd$FVI.B.Close),
        as.numeric(var(FVI.B$accion_usd$FVI.B.Close)), mean(FVI.B$accion_usd$FVI.B.Volume), mercado[mercado$`Acción`=="FVI.B",6], mercado[mercado$`Acción`=="FVI.B",2])
