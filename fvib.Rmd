...
library(kableExtra)
  ...
  datos_accion <-function(accion, directorio, nombre){
    ...
    colnames(accion)<-c("Fecha","Tipo.de.operacion",paste(nombre,".Open",sep=""),paste(nombre,".Close",sep=""),
                        ...
                        ".Cantidad.de.Operaciones",paste(nombre,".Volume",sep=""),".Monto.FVI.Bctivo")
    ...
    accion=accion[c("Fecha", paste(nombre,".Open",sep=""), paste(nombre,".High",sep=""), 
                    ...
                    ".Cantidad.de.Operaciones", ".Monto.FVI.Bctivo", "Tipo.de.operacion") ]
    ##REVISADO
  ...
  FVI.B=datos_accion(accion,paste("C:/Users/analista04/Documents/R/grupointeraval.github.io//","FVI.B.txt",sep=""),"FVI.B")
  ...
  mercado=data.frame(
    ...
    numero_de_acciones=c(10615414833),
    
    
    precio=c(FVI.B$precio)
...
mercado=mercado[c("Acción","Número de acciones","Precio Bs.", "Precio $USD","Capitalización Bs","Capitalización $USD")]
 ...
 resumen=data.frame(
    ...
    valor=c( FVI.B$precio, mercado[mercado$`Acción`=="FVI.B",4], min(FVI.B$accion_usd$FVI.B.Close), max(FVI.B$accion_usd$FVI.B.Close), mean(FVI.B$accion_usd$FVI.B.Close),
        as.numeric(var(FVI.B$accion_usd$FVI.B.Close)), mercado[mercado$`Acción`=="FVI.B",6], mercado[mercado$`Acción`=="FVI.B",2])
...
```{r echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE}
library(DT)
excel=as.data.frame(FVI.B$accion_usd)
excel[,4] <- NULL
...
```{r echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE}
library(DT)
excel2=as.data.frame(FVI.B$accion_bs)
