...
mercado=mercado[c("Acción","Número de acciones","Precio Bs.", "Precio $USD","Capitalización Bs","Capitalización $USD")]
 ...
 resumen=data.frame(
    ...
    valor=c( IVC$precio, min(IVC$accion_usd$IVC.Close), max(IVC$accion_usd$IVC.Close), mean(IVC$accion_usd$IVC.Close),
        as.numeric(var(IVC$accion_usd$IVC.Close)), mean(IVC$accion_usd$IVC.Volume), mercado[mercado$`Acción`=="IVC",6], mercado[mercado$`Acción`=="IVC",2])
