---
title: "Manufacturas de Papel (MANPA)"
...
<p align="center">
  <img width="300px" height="300px" src="MPA.png">
</p>
...
mercado=mercado[c("Acción","Número de acciones","Precio Bs.", "Precio $USD","Capitalización Bs","Capitalización $USD")]
 ...
 resumen=data.frame(
    ...
    valor=c( MPA$precio, min(MPA$accion_usd$MPA.Close), max(MPA$accion_usd$MPA.Close), mean(MPA$accion_usd$MPA.Close),
        as.numeric(var(MPA$accion_usd$MPA.Close)), mean(MPA$accion_usd$MPA.Volume), mercado[mercado$`Acción`=="MPA",6], mercado[mercado$`Acción`=="MPA",2])
