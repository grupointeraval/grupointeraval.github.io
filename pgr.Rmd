---
title: "Proagro (Reporte Grupo Interaval)"
...
<p align="center">
  <img width="100px" height="100px" src="pgr.png">
</p>
...
library(kableExtra)
  ...
  datos_accion <-function(accion, directorio, nombre){
    ...
    colnames(accion)<-c("Fecha","Tipo.de.operacion",paste(nombre,".Open",sep=""),paste(nombre,".Close",sep=""),
                        ...
                        ".Cantidad.de.Operaciones",paste(nombre,".Volume",sep=""),".Monto.PGRctivo")
    ...
    accion=accion[c("Fecha", paste(nombre,".Open",sep=""), paste(nombre,".High",sep=""), 
                    ...
                    ".Cantidad.de.Operaciones", ".Monto.PGRctivo", "Tipo.de.operacion") ]
    ##REVISADO
  ...
  mercado=data.frame(
    ...
    numero_de_acciones=c(732317516),
...
mercado=mercado[c("Acción","Número de acciones","Precio Bs.", "Precio $USD","Capitalización Bs","Capitalización $USD")]
 ...
 resumen=data.frame(
    ...
    valor=c( PGR$precio, mercado[mercado$`Acción`=="PGR",4], min(PGR$accion_usd$PGR.Close), max(PGR$accion_usd$PGR.Close), mean(PGR$accion_usd$PGR.Close),
        as.numeric(var(PGR$accion_usd$PGR.Close)),  mercado[mercado$`Acción`=="PGR",6], mercado[mercado$`Acción`=="PGR",2])
...
```{r echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE}
library(DT)
excel=as.data.frame(PGR$accion_usd)
excel[,4] <- NULL
...
```{r echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE}
library(DT)
excel2=as.data.frame(PGR$accion_bs)
