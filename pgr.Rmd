...
<p align="center">
  <img width="200px" height="200px" src="pgr.png">
</p>
...
mercado=mercado[c("Acción","Número de acciones","Precio Bs.", "Precio $USD","Capitalización Bs","Capitalización $USD")]
 ...
 resumen=data.frame(
    ...
    valor=c( PGR$precio, min(PGR$accion_usd$PGR.Close), max(PGR$accion_usd$PGR.Close), mean(PGR$accion_usd$PGR.Close),
        as.numeric(var(PGR$accion_usd$PGR.Close)), mean(PGR$accion_usd$PGR.Volume), mercado[mercado$`Acción`=="PGR",6], mercado[mercado$`Acción`=="PGR",2])
