...
mercado=mercado[c("Acción","Número de acciones","Precio Bs.", "Precio $USD","Capitalización Bs","Capitalización $USD")]
 ...
 resumen=data.frame(
    ...
    valor=c( abca$precio, min(abca$accion_usd$ABC.A.Close), max(abca$accion_usd$ABC.A.Close), mean(abca$accion_usd$ABC.A.Close),
        as.numeric(var(abca$accion_usd$ABC.A.Close)), mean(abca$accion_usd$ABC.A.Volume), mercado[mercado$`Acción`=="ABC.A",6], mercado[mercado$`Acción`=="ABC.A",2])
