...
mercado=mercado[c("Acción","Número de acciones","Precio Bs.", "Precio $USD","Capitalización Bs","Capitalización $USD")]
 ...
 resumen=data.frame(
    ...
    valor=c( PTN$precio, min(PTN$accion_usd$PTN.Close), max(PTN$accion_usd$PTN.Close), mean(PTN$accion_usd$PTN.Close),
        as.numeric(var(PTN$accion_usd$PTN.Close)), mean(PTN$accion_usd$PTN.Volume), mercado[mercado$`Acción`=="PTN",6], mercado[mercado$`Acción`=="PTN",2])
