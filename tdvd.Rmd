---
title: "C.A. Nacional de Teléfonos de Venezuela"
...
mercado=mercado[c("Acción","Número de acciones","Precio Bs.", "Precio $USD","Capitalización Bs","Capitalización $USD")]
 ...
 resumen=data.frame(
    ...
    valor=c( TDV.D$precio, min(TDV.D$accion_usd$TDV.D.Close), max(TDV.D$accion_usd$TDV.D.Close), mean(TDV.D$accion_usd$TDV.D.Close),
        as.numeric(var(TDV.D$accion_usd$TDV.D.Close)), mean(TDV.D$accion_usd$TDV.D.Volume), mercado[mercado$`Acción`=="TDV.D",6], mercado[mercado$`Acción`=="TDV.D",2])
