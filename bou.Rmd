...
mercado=mercado[c("Acción","Número de acciones","Precio Bs.", "Precio $USD","Capitalización Bs","Capitalización $USD")]
 ...
 resumen=data.frame(
    ...
    valor=c( BOU$precio, min(BOU$accion_usd$BOU.Close), max(BOU$accion_usd$BOU.Close), mean(BOU$accion_usd$BOU.Close),
        as.numeric(var(BOU$accion_usd$BOU.Close)), mean(BOU$accion_usd$BOU.Volume), mercado[mercado$`Acción`=="BOU",6], mercado[mercado$`Acción`=="BOU",2])
