...
mercado=mercado[c("Acción","Número de acciones","Precio Bs.", "Precio $USD","Capitalización Bs","Capitalización $USD")]
 ...
 resumen=data.frame(
    ...
    valor=c( CCR$precio, min(CCR$accion_usd$CCR.Close), max(CCR$accion_usd$CCR.Close), mean(CCR$accion_usd$CCR.Close),
        as.numeric(var(CCR$accion_usd$CCR.Close)), mean(CCR$accion_usd$CCR.Volume), mercado[mercado$`Acción`=="CCR",6], mercado[mercado$`Acción`=="CCR",2])
