...
mercado=mercado[c("Acción","Número de acciones","Precio Bs.", "Precio $USD","Capitalización Bs","Capitalización $USD")]
 ...
 resumen=data.frame(
    dato = c ("Precio","Mínimo","Máximo","Media","Varianza", "Volumen", "Capitalización", "Acciones"),
    
    valor=c( MVZ.A$precio, min(MVZ.A$accion_usd$MVZ.A.Close), max(MVZ.A$accion_usd$MVZ.A.Close), mean(MVZ.A$accion_usd$MVZ.A.Close),
...
kable(resumen) %>%
  ...
  footnote(symbol = c("Valor monetario en dólares. Se considera todo el histórico de la acción "))
